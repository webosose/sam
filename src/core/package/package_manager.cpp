...
void PackageManager::setAppScanFilter(AppScanFilterInterface& scan_filter)
{
    m_appScanner.SetScanFilter(scan_filter);
}

void PackageManager::setAppDescriptionFactory(AppDescriptionFactoryInterface& factory)
{
    m_appScanner.SetAppDescFactory(factory);
}
...
void PackageManager::addApp(const std::string& app_id, AppDescPtr new_desc, AppStatusChangeEvent event)
{
...
std::string PackageManager::appStatusChangeEventToString(const AppStatusChangeEvent& event)
{
    switch (event) {
