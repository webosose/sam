...
class PrerequisiteItem {
 public:
  ...
  PrerequisiteItemStatus Status() const { return status_; }
...
{
 public:
  PrerequisiteMonitor(std::function<void(PrerequisiteResult)> result_handler) : result_handler_(result_handler) {}
  ~PrerequisiteMonitor();
