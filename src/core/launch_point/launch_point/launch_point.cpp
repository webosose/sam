...
LaunchPoint::LaunchPoint(const std::string& id, const std::string& lp_id) : lp_type_(LPType::UNKNOWN),
                                                                            id_(id),
                                                                            launch_point_id_(lp_id),
                                                                            system_app_(false),
                                                                            removable_(false),
                                                                            default_(false),
                                                                            visible_(false),
...
std::string LaunchPoint::LpTypeAsString() const {
  switch (lp_type_) {
    case DEFAULT: return std::string("default");
    case BOOKMARK: return std::string("bookmark");
    default: break;
  }
...
void LaunchPoint::SetAttrWithJson(const pbnjson::JValue& data) {
  ...
  SetTileSize(data["tileSize"].asString());
...
void LaunchPoint::SetTileSize(const std::string& tile_size) {
  if (tile_size.empty())
    return;
